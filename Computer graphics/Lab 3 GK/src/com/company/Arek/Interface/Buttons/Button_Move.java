...
public class Button_Move extends MyButton {
    ...
    public Button_Move(Left_Panel_Vector left_panel_vector,Left_Panel_Rastor left_panel_rastor,JTextField xPoint,JTextField yPoint){
        this.setText("Przenieś");
